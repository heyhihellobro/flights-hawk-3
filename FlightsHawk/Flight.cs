        ...
        public NameValueCollection GetFlightNVCollection(int id)
        {
            ...
            if (dataReader.HasRows)
            {
                while (dataReader.Read())
                {
                    ...
                    business_class_price = Convert.ToDouble(dataReader[10].ToString());
                    first_class_price = Convert.ToDouble(dataReader[11].ToString());
                    distance = Convert.ToDouble(dataReader[12].ToString());
                }
            }
            ...
            data["business_class_price"] = business_class_price.ToString(CultureInfo.InvariantCulture);
            data["first_class_price"] = first_class_price.ToString(CultureInfo.InvariantCulture);
            data["distance"] = distance.ToString(CultureInfo.InvariantCulture);
